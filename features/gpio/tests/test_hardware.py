...
class TestGPIOManager:
    ...
    def test_singleton_pattern(self, gpio_hardware):
    ...
    def test_get_valid_pins_success(self, gpio_hardware):
        # Configure mock to return valid GPIO functions for certain pins
        def gpio_function_side_effect(pin):
            if pin in [2, 3, 4]:
                return IN
    ...
    def test_get_valid_pins_no_pins(self, gpio_hardware):
    ...
    def test_setup_input_pin_basic(self, gpio_hardware, mock_logger):
        pin = 18
    ...
    def test_setup_input_pin_with_edge_detection(self, gpio_hardware):
        pin = 18
        callback = Mock()
        bouncetime = 300
    ...
    def test_setup_input_pin_edge_detection_validation(self, gpio_hardware):
    ...
    def test_setup_input_pin_invalid_pull_up_down(self, gpio_hardware):
        with pytest.raises(ValueError, match="Invalid pull-up/down value"):
            gpio_hardware.setup_input_pin(18, pull_up_down=999)

    def test_setup_output_pin_basic(self, gpio_hardware, mock_logger):
        pin = 18
    ...
    def test_setup_output_pin_with_initial_state(self, gpio_hardware):
        pin = 18
    ...
    def test_setup_output_pin_invalid_state(self, gpio_hardware):
    ...
    def test_set_output_state_success(self, gpio_hardware, mock_logger):
    ...
    def test_set_output_state_invalid_pin(self, gpio_hardware):
    ...
    def test_set_output_state_invalid_state(self, gpio_hardware):
    ...
    def test_get_pin_state_success(self, gpio_hardware):
    ...
    def test_get_pin_state_invalid_pin(self, gpio_hardware):
    ...
    def test_cleanup(self, gpio_hardware, mock_logger):
